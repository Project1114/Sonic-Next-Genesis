...
DACbanks:
	banks 81, 81, 82_85, 82_85, 82_85, 82_85, 86, 87
	banks 88, 89, 8A_8B, 8A_8B, 8C, 8D_8E, 8D_8E, 8F
	banks 90_93, 90_93, 90_93, 90_93, 94_97, 94_97, 94_97, 94_97
	banks 98_9A, 98_9A, 98_9A, 9B, 9C, 9D, 9E, 9F
	banks A0, A1, A2, A3, A4, A5, A6, A7, A8
	banks A9, AA, AB, AC, AD_AE, AD_AE, AF_B0
	banks AF_B0, B1, B2_B3_S3, B2_B3_S3, B4C1_C4, B5, B6, B7
	banks B8_B9, B8_B9, BA, BB, BC, BD, BE, BF
	banks C0, B4C1_C4, B4C1_C4, B4C1_C4, B4C1_C4
; =============== S U B	R O U T	I N E =======================================
...
loc_464:				; CODE XREF: sub_3C9+78j
		ld	l, a
		ld	b, (ix+22h)
		inc	b
		ex	de, hl
...
loc_63D:				; CODE XREF: sub_4FB+161j
		...
		ldi
		ld	(1C33h), hl
		call	sub_7C5		; <- init FM or DAC
		pop	bc
		djnz	loc_63D

		ld	a, (iy+3)	; begin PSG init
		zor	a
		jp	z, sub_690
		ld	b, a
		ld	hl, byte_6A3
...
MusicBanks:	music musbnk, musbnk, musbnk, musbnk
			music musbnk, musbnk, musbnk, musbnk
			music musbnk, musbnk, musbnk, musbnk
			music musbnk, musbnk, musbnk, musbnk
			music musbnk2, musbnk2, musbnk2, musbnk2
			music musbnk2, musbnk2, musbnk2, musbnk2
			music musbnk2, musbnk2, musbnk2, musbnk2
			music musbnk2, musbnk2, musbnk2, musbnk2
			music musbnk2, musbnk2, musbnk2, musbnk2
...
off_BFD:	dw loc_C51, loc_C77, loc_C7B, loc_C7F, loc_C85,	loc_CA1
		...
		dw loc_EE8, loc_F2F
off_C3D:	dw loc_F36, loc_F3A, loc_F42, loc_F7D, loc_F8B,	loc_F9c
...
loc_F9c:				; DATA XREF: ROM:off_C3Do
		ld	(ix+18h), 80h ;	'Ä'
		ld	(ix+19h), e
		ld	(ix+1Ah), d
...
; ---------------------------------------------------------------------------
ModEnvPointers:	dw ModEnv00, ModEnv01, ModEnv02, ModEnv03
		dw ModEnv04, ModEnv05, ModEnv06, ModEnv07

ModEnv01:	db    0
ModEnv00:	incbin "ModEnv/00.bin"
ModEnv02:	incbin "ModEnv/02.bin"
ModEnv03:	incbin "ModEnv/03.bin"
ModEnv04:	incbin "ModEnv/04.bin"
ModEnv05:	incbin "ModEnv/05.bin"
ModEnv06:	incbin "ModEnv/06.bin"
ModEnv07:	incbin "ModEnv/07.bin"

; ---------------------------------------------------------------------------
VolEnvPointers:	dw VolEnv00, VolEnv01, VolEnv02, VolEnv03, VolEnv04, VolEnv05
...
VolEnv00:	incbin "VolEnv/00.bin"
VolEnv01:	incbin "VolEnv/01.bin"
VolEnv02:	incbin "VolEnv/02.bin"
VolEnv03:	incbin "VolEnv/03.bin"
VolEnv04:	incbin "VolEnv/04.bin"
VolEnv05:	incbin "VolEnv/05.bin"
VolEnv06:	incbin "VolEnv/06.bin"
VolEnv07:	incbin "VolEnv/07.bin"
VolEnv08:	incbin "VolEnv/08.bin"
VolEnv09:	incbin "VolEnv/09.bin"
VolEnv0A:	incbin "VolEnv/0A.bin"
VolEnv0B:	incbin "VolEnv/0B.bin"
VolEnv0C:	incbin "VolEnv/0C.bin"
VolEnv0D:	incbin "VolEnv/0D.bin"
VolEnv0E:	incbin "VolEnv/0E.bin"
VolEnv0F:	incbin "VolEnv/0F.bin"
VolEnv10:	incbin "VolEnv/10.bin"
VolEnv11:	incbin "VolEnv/11.bin"
VolEnv12:	incbin "VolEnv/12.bin"
VolEnv13:	incbin "VolEnv/13.bin"
VolEnv14:	incbin "VolEnv/14.bin"
VolEnv15:	incbin "VolEnv/15.bin"
VolEnv16:	incbin "VolEnv/16.bin"
VolEnv17:	incbin "VolEnv/17.bin"
VolEnv18:	incbin "VolEnv/18.bin"
VolEnv19:	incbin "VolEnv/19.bin"
VolEnv1A:	incbin "VolEnv/1A.bin"
VolEnv1B:	incbin "VolEnv/1B.bin"
VolEnv1C:	incbin "VolEnv/1C.bin"
VolEnv1D:	incbin "VolEnv/1D.bin"
VolEnv1E:	incbin "VolEnv/1E.bin"
VolEnv1F:	incbin "VolEnv/1F.bin"
VolEnv20:	incbin "VolEnv/20.bin"
VolEnv21:	incbin "VolEnv/21.bin"
VolEnv22:	incbin "VolEnv/22.bin"
VolEnv23:	incbin "VolEnv/23.bin"
VolEnv24:	incbin "VolEnv/24.bin"

VolEnv25:	incbin "VolEnv/25.SK.bin"
VolEnv26:	incbin "VolEnv/26.bin"

; ---------------------------------------------------------------------------
; 1618 167E 17D8
MusicPointers:		dw MTitle, MMenu, MWO1, MWO2
					dw MDD1, MDD2, MWA1, MWA2
					dw MCC1, MCC2, MFC1, MFC2
					dw MRT1, MRT2, MTJ1, MTJ2
					dw MKV1, MKV2, MAB1, MAB2
					dw MBossE, MBossC, MBossM, MBonus
					dw MSpecial, MInvincible, MOutro, MResults
					dw MGameOver, MEnd, MFinalBoss1, MFinalBoss2
					dw MCredits1, MCredits2, MCredits3, MCredits4
					dw MNull, MNull, MNull, M1UP
					dw MNull, MNull, MNull, MNull
					dw MNull, MNull, MNull, MNull
					dw MNull, MNull
SFXPointers:		dw Sfx_33, Sfx_34, Sfx_35, Sfx_36
					dw Sfx_37, Sfx_38, Sfx_39, Sfx_3A
					dw Sfx_3B, Sfx_3C, Sfx_3D, Sfx_3E
