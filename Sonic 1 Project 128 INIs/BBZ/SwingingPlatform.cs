...
namespace S12005ObjectDefinitions.GHZ
{
    class SwingingPlatform : ObjectDefinition
    {
        ...
        {
            byte[] artfile = ObjectHelper.OpenArtFile("../artnem/bbzswing.bin", CompressionType.Nemesis);
            img = ObjectHelper.MapASMToBmp(artfile, "../_maps/obj15bbz.asm", 0, 2);
            for (int i = 0; i < labels.Length; i++)
                imgs.Add(ObjectHelper.MapASMToBmp(artfile, "../_maps/obj15bbz.asm", labels[i], i == 1 ? 1 : 2));
        }
