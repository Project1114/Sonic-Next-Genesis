FC1_Header:
	...
	sHeaderPSG	FC1_PSG1, $F4, $05, $00, VolEnv_00
	sHeaderPSG	FC1_PSG2, $F4, $08, $00, VolEnv_00
	sHeaderPSG	FC1_PSG3, $00, $05, $00, VolEnv_00

FC1_FM1:
	sPatFM		$00
	ssModZ80	$20, $01, $09, $04
	sCall		FC1_Call5
	sCall		FC1_Call6
...
FC1_Loop29:
	...
	dc.b dMidTom, dFloorTom, dFloorTom, dFloorTom, dFloorTom
...
FC1_Jump9:
	...
	dc.b dSnare, dSnare, dSnare, dSnare, dLowTom, dLowTom, dFloorTom, dFloorTom
...
FC1_Loop32:
	...
	dc.b dFloorTom, dFloorTom, dFloorTom, dFloorTom, dKick, dKick, dKick, dKick
...
FC1_Loop33:
	...
	dc.b dMidTom, dMidTom, dMidTom, dMidTom, dFloorTom, dFloorTom, dFloorTom, dFloorTom
	sJump		FC1_Jump9
...
FC1_Patches:
	...
	spAmpMod	$00, $00, $00, $00
	spDecayRt	$0E, $02, $05, $01
	spSustainRt	$01, $04, $00, $06
	...
	spAmpMod	$00, $00, $00, $00
	spDecayRt	$06, $05, $05, $01
	spSustainRt	$08, $15, $05, $04
