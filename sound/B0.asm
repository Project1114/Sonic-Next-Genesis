sfxb0_Header:
	sHeaderInit	; Z80 offset is $F507
	sHeaderPatch	sfxb0_Patches
	sHeaderTick	$01
	sHeaderCh	$03
	sHeaderSFX	$80, $02, sfxb0_FM3, $F5, $08
	sHeaderSFX	$80, $04, sfxb0_FM4, $00, $00
	sHeaderSFX	$80, $05, sfxb0_FM5, $00, $00
...
sfxb0_Patches:
	...
	spAmpMod	$00, $00, $00, $00
	spDecayRt	$17, $1A, $11, $0E
	spSustainRt	$00, $14, $0F, $10
