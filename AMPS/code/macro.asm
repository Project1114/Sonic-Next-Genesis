...
cSoundID =	__rs		; channel sound ID. SFX only. Used for continuous SFX
cData		rs.l 1		; tracker address for the channel
cStatPSG4 =	__rs		; PSG4 type value. PSG3 only
...
cfbWater	rs.b 1		; set if underwater mode is disabled
...
mQueue		rs.b FEATURE_QUEUESIZE; sound queue
	if 1&(__rs)
...
mBackFlags	rs.b 1		; back-up various driver flags, see below
	endif
; ---------------------------------------------------------------------------
